...
export default function NewsPage() {
  ...
  const allPosts = [
    ...
    {
      id: "a2",
      title: "Conseils pour réussir l'animation de votre mariage",
      excerpt:
        "Timing, formats et astuces pour intégrer la magie au vin d'honneur et au repas.",
      date: "2025-03-28",
      read: 5,
      category: "Conseils",
      color: "bg-gray-300",
    ...
    {
      id: "a3",
      title: "Magie digitale : attirer du trafic sur un stand",
      excerpt:
        "Focus sur des effets personnalisés (logo, produit) pour capter l'attention et générer des leads.",
      date: "2025-02-17",
      read: 4,
    ...
    },
    {
      ...
      excerpt:
        "Passage média et démonstration de lecture de pensée avec les auditeurs.",
      date: "2024-11-09",
      read: 2,
      category: "Presse",
      color: "bg-gray-200",
    ...
    {
      id: "a5",
      title: "Backstage : préparation d'un spectacle",
      excerpt:
        "Coulisses, répétitions, gestion du matériel et coordination technique.",
      date: "2024-09-21",
      read: 3,
      category: "Backstage",
      color: "bg-gray-300",
    ...
    {
      id: "a6",
      title: "Séminaires & congrès : formats qui fonctionnent",
      excerpt:
        "Ice-breakers, interludes scéniques et moments participatifs pour fédérer vos équipes.",
      date: "2024-07-10",
      read: 4,
      category: "Prestations",
      color: "bg-gray-200",
